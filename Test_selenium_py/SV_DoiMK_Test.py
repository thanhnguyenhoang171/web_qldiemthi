...
btn_doiMK = driver.find_element(By.CSS_SELECTOR, "#menu > ul > li:nth-child(3) > a").click()

inputOldPass = input("Nhap mat khau cu: ")
inputNewPass = input("Nhap mat khau moi: ")
inputReNewPass = input("Nhap mat lai khau moi: ")

old_pass = driver.find_element(By.CSS_SELECTOR, "body > div > form:nth-child(2) > input[type=password]:nth-child(1)")
old_pass.send_keys(inputOldPass)

new_pass = driver.find_element(By.CSS_SELECTOR, "body > div > form:nth-child(2) > input[type=password]:nth-child(3)")
new_pass.send_keys(inputNewPass)

re_new_pass = driver.find_element(By.CSS_SELECTOR, "body > div > form:nth-child(2) > input[type=password]:nth-child(5)")
re_new_pass.send_keys(inputReNewPass)

submit_doiMK = driver.find_element(By.NAME, "hs").click()

error_doiMK = driver.find_element(By.XPATH, "//*[@id='errors']")
print(error_doiMK.text)

el_back = driver.find_element(By.NAME, "back").click()
el_logout = driver.find_element(By.CSS_SELECTOR, "#menu > ul > li:nth-child(4) > a").click()
el_xemdiem = driver.find_element(By.CSS_SELECTOR, "#menu > ul > li:nth-child(5) > a").click()
