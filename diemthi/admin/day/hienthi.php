    ...
    <table align="center" border="1" cellspacing="0" cellpadding="10">
        ...
        <?php foreach ($day as $item) { ?>
            <tr style='background-color: #f1f1f1;'>
                ...
                <td>
                    <?php echo $item['MoTaPhanCong']; ?>
                </td>
                <td>

                    <?php echo "<a href='day/suaday.php?id=$item[MaDayHoc]'>
            <button type='button' class = 'fix-button'>Sửa</button>
            </a>"; ?>
                </td>
                <td>
                    <?php echo "<a href='day/xoaday.php?id=$item[MaDayHoc]' onclick='return XacNhan();'>
